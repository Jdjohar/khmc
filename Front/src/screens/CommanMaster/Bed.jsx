...
const Bed = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [bedResponse, wardResponse, departmentResponse] = await Promise.all([
          fetch("https://khmc.onrender.com/api/beds"),
          fetch("https://khmc.onrender.com/api/wards"),
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedBedId) {
      ...
      try {
        const response = await fetch(`https://khmc.onrender.com/api/beds/${selectedBedId}`, {
          method: 'PUT',
          headers: {
      ...
      try {
        const response = await fetch('https://khmc.onrender.com/api/beds', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
